...
class DiffusionSampler(pl.LightningModule):
    ...
    def predict_mean(self, x_t, t) -> torch.Tensor:
        ...
        x_t = x_t - self.get_buffer('beta')[t] / self.get_buffer('sqrt_one_minus_alpha_bar')[t] * pred_noise
...
if __name__ == '__main__':
    ...
    #print(trainer(torch.rand(8, *input_shape, device=DEVICE)))

    sampler = DiffusionSampler(backbone, time_steps=10).to(DEVICE)
    #print(sampler(torch.rand(8, *input_shape, device=DEVICE)))
